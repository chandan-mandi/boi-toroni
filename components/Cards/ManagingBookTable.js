...
const ManagingBookTable = ({ book, color }) => {
    ...
    const users = [
        "https://lh3.googleusercontent.com/a-/AOh14GjpDl25hhU2FxeBD_-FIa0LrlTNvavf2izsxaeLFOg=s96-c",
        "https://lh3.googleusercontent.com/a-/AOh14GhbWWDknudx7PxrbMRJCzRT7uId--OSkdSSPfwT=s96-c",
        "https://lh3.googleusercontent.com/a-/AOh14GgJdzWPVALmLURbggSqGI6iQdWti54zcaLqUYLlCA=s96-c",
        "https://lh3.googleusercontent.com/a-/AOh14Gi0-8IqOedC8IcP1l-RRZXli2NYz5qL31oWCL1l=s96-c",
    ];
    return (
        <>
            <tbody>
                <tr>
                    ...
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                        <div className="flex items-center">
                            <span className="mr-2">
                                {percentageRating ? percentageRating : 0}%
                            </span>
