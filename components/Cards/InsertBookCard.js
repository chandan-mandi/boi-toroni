...
const InsertBookCard = ({update, singleBookInfo, src}) => {
  console.log(singleBookInfo);
    ...
    const onSubmit = async (data) => {
        ...
        if (update) {
          ...
          let imageURL = singleBookInfo.thumbnail;
          if (data.thumbnail[0]) {
        ...
        const bookdata = {
          ...
          axios.put(`http://localhost:5000/books/update/${singleBookInfo._id}`,bookdata)
          .then(res => {
            if(res.data.modifiedCount === 0){
              toast.error("Please Update your Book Information", {
                  id: loading,
              });
            } else {
              toast.success("Your Book Successfully Updated", {
                id: loading,
            });
            }
          })
        ...
        <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blue-100 border-0">
          <div className="rounded-t bg-white mb-0 px-6 py-6">
            <div className="text-center flex justify-between">
              <h6 className="text-blueGray-700 text-xl font-bold">{update ? "Update Book":"Add book"}</h6>
              <button
                ...
                <div className="w-full lg:w-6/12 px-4">
                  <div className="relative w-full mb-3">
                    ...
                    <input
                      ...
                      defaultValue={update ? singleBookInfo?.book_name : null}
                ...
                <div className="w-full lg:w-6/12 px-4">
                  <div className="relative w-full mb-3">
                    ...
                    <input
                      type="text"
                      className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                      defaultValue={update ? singleBookInfo?.author : null}
                ...
                <div className="w-full lg:w-6/12 px-4">
                  <div className="relative w-full mb-3">
                    ...
                    <input
                      type="text"
                      className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                      defaultValue={update ? singleBookInfo?.publisher : null}
                ...
                <div className="w-full lg:w-6/12 px-4">
                  <div className="relative w-full mb-3">
                    ...
                    <input
                      type="number"
                      className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                      defaultValue={update ? singleBookInfo?.pages : null}
                      {...register("pages")}
                    />
                  </div>
                </div>
              ...
              <div className="flex flex-wrap">
                <div className="w-full lg:w-12/12 px-4">
                  <div className="relative w-full mb-3">
                    ...
                    <input
                      type="text"
                      className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                      defaultValue={update ? singleBookInfo?.authordetails : null}
                ...
                <div className="w-full lg:w-4/12 px-4">
                  <div className="relative w-full mb-3">
                    ...
                    <input
                      type="text"
                      className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                      defaultValue={update ? singleBookInfo?.language : null}
                      {...register("language")}
                    />
                  </div>
                </div>
                <div className="w-full lg:w-4/12 px-4">
                  <div className="relative w-full mb-3">
                    ...
                    <input
                      type="number"
                      className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                      defaultValue={update ? singleBookInfo?.price : null}
                ...
                <div className="w-full lg:w-4/12 px-4">
                  <div className="relative w-full mb-3">
                    ...
                    <div className="flex">
                      {update && singleBookInfo?.thumbnail ? <div className="img-width w-20">
                        <Image className="h-12 w-12 bg-white rounded-full border" loader={() => singleBookInfo.thumbnail} src={singleBookInfo.thumbnail} width={50} height={50} alt="User Photo"/>
                      </div> : ""}
                    <input
                      type="file"
                      className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                ...
                <div className="w-full lg:w-12/12 px-4">
                  <div className="relative w-full mb-3">
                    ...
                    <textarea
                      ...
                      className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                      rows="4"
                      defaultValue={update ? singleBookInfo?.book_description : null}
