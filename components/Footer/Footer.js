    ...
    return (
        <div>
            ...
            <a href="https://flowbite.com" className="flex items-center">
                ...
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Boitoroni</span>
            </a>
        </div>
                    <div>
                ...
                <div className="py-6 px-4 bg-gray-700 md:flex md:items-center md:justify-between">
                    <span className="text-sm text-gray-300 sm:text-center">© 2022 <a href="https://flowbite.com">boitoroni™</a>. All Rights Reserved.
                    </span>
