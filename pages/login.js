    ...
    return (
        <div className="w-screen h-screen flex justify-center items-center bg-white relative">
            <img
                ...
                src="https://cdn.pixabay.com/photo/2017/12/25/19/18/girl-3038974_960_720.jpg"
                alt=""
            />

            <div className="absolute top-0 left-0 right-0 bottom-0 bg-black bg-opacity-50  "></div>
            <div
                className="z-10 flex justify-center items-center border border-gray-200 rounded-full p-2
